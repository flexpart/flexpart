...
!                                                                              *
!        Modified by Massimo Cassiani, 2016 (mc)                               *
!        Adapt for NorESM/CAM4 verticla level                                  *
!        added matrix qv2 and ps_tplus1_and_min1                               *
!        added variable netadot, method_w                                      *
!                                                                              * 
!                                                                              *
!*******************************************************************************
...
module com_mod
  ...
  ! method_w: indicate what method to be used for obtainin vertical velocity
  ...
  integer :: nx,ny,nxmin1,nymin1,nxfield,nuvz,nwz,nz,nmixz,nlev_ec,netadot !netadot added by mc
  ...
  ! 2d fields
  !**********
  real :: ps_tplus1_and_min1(0:nxmax-1,0:nymax-1,2) !this is to be used ot obtain edtadot from omega by mc
  ...
  real :: qv2(0:nxmax-1,0:nymax-1,1,2) !specific humidity at reference height 2m !added by mc for noresm version
